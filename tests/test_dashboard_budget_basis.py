...
def test_the_budget_columns_say_groundwater_budget():
    ...
    to "Groundwater budget" -- the budget now spends a calculated row's stamped
    ...
    the per-column "GW allocation (AF)" in 142-01)."""
