...
ACCOUNT_COLUMNS = [
    ("FIG-accounting-029", "Consumptive Use (AF)"),
    ("FIG-accounting-030", "Surface (AF)"),
    ("FIG-accounting-031", "Groundwater (AF)"),
...
ZONE_COLUMNS = [
    ...
    ("FIG-accounting-038", "Surface (AF)"),
    ("FIG-accounting-039", "Groundwater (AF)"),
